...
function ciniki_materiamedica_plantImageDelete(&$ciniki) {
    ...
    $rc = ciniki_materiamedica_checkAccess($ciniki, $args['tnid'], 'ciniki.materiamedica.plantImageDelete'); 
    if( $rc['stat'] != 'ok' ) { 
        return $rc;
    }   
    ...
    return ciniki_core_objectDelete($ciniki, $args['tnid'], 'ciniki.materiamedica.plant_image', $args['plant_image_id'], $item['uuid'], 0x07);
}
?>
