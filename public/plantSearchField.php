...
// -------
//
function ciniki_materiamedica_plantSearchField($ciniki) {
    //  
    ...
    $rc = ciniki_core_prepareArgs($ciniki, 'no', array(
        ...
        'field'=>array('required'=>'yes', 'blank'=>'no', 'validlist'=>array('family', 'genus', 'species', 'common_name'), 'name'=>'Field'),
    ...
    $rc = ciniki_materiamedica_checkAccess($ciniki, $args['business_id'], 'ciniki.materiamedica.plantSearchField'); 
    if( $rc['stat'] != 'ok' ) { 
        return $rc;
    }   
