...
// -------
//
function ciniki_materiamedica_plantActionSearchField($ciniki) {
    //  
    ...
    $rc = ciniki_core_prepareArgs($ciniki, 'no', array(
		...
		'field'=>array('required'=>'yes', 'blank'=>'no', 'validlist'=>array('system', 'action'), 'name'=>'Field'),
    ...
    $rc = ciniki_materiamedica_checkAccess($ciniki, $args['business_id'], 'ciniki.materiamedica.plantActionSearchField', 0, 0); 
    if( $rc['stat'] != 'ok' ) { 
        return $rc;
    }   
