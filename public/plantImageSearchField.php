...
// -------
//
function ciniki_materiamedica_plantImageSearchField($ciniki) {
    //  
    ...
    $rc = ciniki_core_prepareArgs($ciniki, 'no', array(
		...
		'field'=>array('required'=>'yes', 'blank'=>'no', 'validlist'=>array('location'), 'name'=>'Field'),
    ...
    $rc = ciniki_materiamedica_checkAccess($ciniki, $args['business_id'], 'ciniki.materiamedica.plantImageSearchField', 0, 0); 
    if( $rc['stat'] != 'ok' ) { 
        return $rc;
    }   
